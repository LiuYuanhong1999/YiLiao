<template>
  <el-form ref="ruleFrom" :model="ruleFrom"  label-width="100px">
    <el-page-header content="门诊处方详情页" @back="goBack" />
    <!--数据表格-->
    <el-row>
      <el-col :span="24">
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    initData1(){
      this.axios.get("http://localhost:8088/find-prescription_details_project",{params:{prescriptionId:this.rcId}})
          .then((v) => {
    ...
    initData(){
      this.axios.get("http://localhost:8088/find-prescription_details_drug",{params:{prescriptionId:this.rcId}})
          .then((v) => {
